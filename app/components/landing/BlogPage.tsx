...
export default function BlogPage() {
  ...
  const translations = {
    tr: {
      tag: "BORSAZEKA BLOG",
      title: "Finansal Teknolojiler & Stratejiler",
      subtitle: "Yapay zeka robotlarımız, borsa stratejilerimiz ve algoritmik ticaret dünyasına dair güncel makaleler ve analizler.",
      featuredLabel: "Öne Çıkan Yazı",
      readMore: "Devamını Oku",
    },
    en: {
      tag: "BORSAZEKA BLOG",
      title: "Financial Technologies & Strategies",
      subtitle: "Latest articles, analyses and updates on our AI trading robots, stock strategies and the algorithmic trading ecosystem.",
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        ...
        {featuredPost && (
          <div 
            ...
            className="bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 mb-16 group cursor-pointer"
          >
            {/* Image Wrap */}
            <div className="lg:col-span-7 relative h-64 sm:h-80 lg:h-auto overflow-hidden min-h-[300px]">
              <Image
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {gridPosts.map((post) => (
            <div 
              ...
              className="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col group cursor-pointer"
            >
              {/* Image */}
              ...
              <div className="p-6 flex flex-col flex-grow justify-between">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-50 text-[11px] font-semibold text-slate-400">
