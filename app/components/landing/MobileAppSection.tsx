...
function QRCodePlaceholder() {
  return (
    ...
    >
      ...
      <rect x="5" y="5" width="30" height="30" rx="3" stroke="rgba(16,185,129,0.7)" strokeWidth="3" fill="none" />
      <rect x="12" y="12" width="16" height="16" rx="1" fill="rgba(16,185,129,0.7)" />
      <rect x="65" y="5" width="30" height="30" rx="3" stroke="rgba(16,185,129,0.7)" strokeWidth="3" fill="none" />
      <rect x="72" y="12" width="16" height="16" rx="1" fill="rgba(16,185,129,0.7)" />
      <rect x="5" y="65" width="30" height="30" rx="3" stroke="rgba(16,185,129,0.7)" strokeWidth="3" fill="none" />
      <rect x="12" y="72" width="16" height="16" rx="1" fill="rgba(16,185,129,0.7)" />
      ...
      {[
        ...
        <rect key={i} x={x} y={y} width="4" height="4" fill="rgba(16,185,129,0.55)" />
      ))}
    </svg>
  );
}
  ...
  return (
    <div className={s.phoneWrapper}>
      ...
      <div className={`${s.floatChip} ${s.floatChipLeft}`} aria-hidden="true">
        <span className={s.floatChipDot} />
        <span className={s.floatChipText}>+%12.4 Bugün</span>
      </div>
        ...
        <div className={s.phoneScreen}>
          ...
          <div className={s.phoneStatusBar} aria-hidden="true">
            ...
            <div className={s.phoneStatusIcons}>
              ...
              <svg width="25" height="12" viewBox="0 0 25 12" fill="currentColor"><rect x="0.5" y="0.5" width="21" height="11" rx="3.5" stroke="currentColor" strokeOpacity=".35" fill="none"/><rect x="2" y="2" width="16" height="8" rx="2" fill="#10b981"/><rect x="22.5" y="4" width="2" height="4" rx="1" fill="currentColor" fillOpacity=".4"/></svg>
            </div>
          </div>
          ...
          <div className={s.phoneVideoWrapper}>
            ...
            <div className={s.phoneVideoFallback} aria-hidden="true">
              ...
              <svg className={s.mockChart} viewBox="0 0 280 160" fill="none" preserveAspectRatio="none">
                ...
                <path d="M0 130 L30 115 L60 125 L90 90 L120 100 L150 70 L180 80 L210 50 L240 60 L280 30" stroke="#10b981" strokeWidth="2" fill="none" className={s.chartLine}/>
                <circle cx="280" cy="30" r="4" fill="#10b981" className={s.chartDot}/>
              </svg>
              {/* Stats row */}
              ...
              <div className={s.mockRobotCard}>
                <div className={s.mockRobotIcon}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2"><rect x="3" y="11" width="18" height="10" rx="2"/><path d="M12 11V7"/><circle cx="12" cy="5" r="2"/><path d="M7 11V9a5 5 0 0 1 10 0v2"/></svg>
                </div>
                <div>
